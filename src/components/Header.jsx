      ...
      <Fade delay={100} triggerOnce={true} cascade={true} >
        <div className="row justify-content-center">
          <div className="col-md-8 text-center">
            ...
            <h3>Diselenggarakan pada 22 juni 2025 di Jakarta</h3>
            <p>
            ...
            <div className="col-lg-6">
              <div className="row">
                <div className="col-8 text-end">
                  ...
                  <p>Putra dari Bpk. Nurzaeni <br /> dan <br /> Ibu Ipsum</p>
                </div>
                <div className="col-4">
            ...
            <div className="col-lg-6">
              <div className="row">
                ...
                <div className="col-8">
                  <h3>Neng Restiani</h3>
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptates non labore ullam repudiandae voluptas saepe!</p>
                  <p>Putra dari Bpk. Oyeh Komarudin <br /> dan <br /> Ibu Ipsum</p>
                </div>
              </div>
            </div>
          </div>
