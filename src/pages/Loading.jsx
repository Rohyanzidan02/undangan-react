...
const Loading = () => {
  ...
  return (
    <div className="loading-page" style={{ backgroundImage: `url(${Bg})` }}>
      <div className="container1">
        <div className="text logo-name">Kris Ananda Saputra</div>
      </div>
      ...
      <div className="container1">
        <div className="text logo-name">Neng Restiani</div>
      </div>
    </div>
  );
};
